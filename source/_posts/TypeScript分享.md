...
[代码例子](https://github.com/limoon7/ts-base.git)
...
```ts
declare module "@7fresh/mui" {
  export const Header: any;
  export const FloorNotice: any;
  export const FloorScrollCommon: any;
  export const FloorThemeProduct: any;
  export const FloorProductGroup: any;
  export const FloorCoupon: any;
  export const FloorSpecialPrice: any;
  export const FloorRankingListProduct: any;
  export const FloorProductTabGoods: any;
  export const CommonTab: any;
  export const EmptyPage: any;
  export const FloorSingleItems: any;
  export const FloorImg: any;
  export const FloorActivitySeckill: any;
  export const FloorAdPop: any;
  export const FloorFloatImg: any;
  export const FloorQualitySelected: any;
  export const FloorDailyCheckIn: any;
  export const FloorIndexIcon: any;
  export const FloorNews: any;
  export const FloorProductAdvanceSale: any;
  export const FloorScrambleToday: any;
  export const FloorTimeCoupon: any;
  export const FloorSidebar: any;
  export const TopTabNav: any;
  export const FloorSeckillNew: any;
  export const FloorProductCross: any;
}
```
